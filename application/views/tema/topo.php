...
<head>
  <title><?= $configuration['app_name'] ?: 'Fenix Cargo' ?></title>
  <meta charset="UTF-8" />
...
<body>
  <!--Header-part-->
  <div id="header">
    <h1><a href=""> <?= $configuration['app_name'] ?: 'Fenix Cargo' ?> </a></h1>
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      ...
      <li class="pull-right"><a href="https://infinitytec.info" target="_blank"><i class="fas fa-asterisk"></i> <span class="texto">Versão:
